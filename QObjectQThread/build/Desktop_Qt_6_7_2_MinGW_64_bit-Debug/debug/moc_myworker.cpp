...
constexpr auto qt_meta_stringdata_CLASSMyWorkerENDCLASS = QtMocHelpers::stringData(
    "MyWorker",
    "showResults",
    "",
    "res",
...
void MyWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->showResults((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        ...
        {
            using _t = void (MyWorker::*)(int );
            if (_t _q_method = &MyWorker::showResults; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyWorker::*)();
            if (_t _q_method = &MyWorker::doneProcess; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyWorker::showResults(int _t1)
{
